...
export function Past30D() {
  ...
  const toggleSort = (field: 'symbol' | 'price') => {
    if (sortBy === field) {
      ...
      <div className="container mx-auto p-4">
        <header className="border-b">
          <div className="container mx-auto p-4 md:p-6">
            <div className="flex items-center justify-between relative">
              ...
              <h1 className="text-lg font-semibold">Past 30 Days</h1>
        ...
        <div className="bg-card rounded-lg shadow-sm border overflow-hidden">
          <div className="grid grid-cols-12 gap-4 p-4 border-b font-medium">
            ...
            <div className="col-span-3 md:col-span-3 text-right cursor-pointer" onClick={() => toggleSort('price')}>
              Price
